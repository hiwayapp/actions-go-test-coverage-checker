...
const errors_1 = __nccwpck_require__(564);
const instrument_1 = __nccwpck_require__(645);
/**
...
const os = __importStar(__nccwpck_require__(37));
const packageJson = __nccwpck_require__(849); // eslint-disable-line import/no-commonjs, @typescript-eslint/no-var-requires
/**
...
var pkg = __nccwpck_require__(593);
...
var Axios = __nccwpck_require__(269);
...
const webhook_1 = __nccwpck_require__(95);
...
const buildLowerThanThresholdLog = (coverage, threshold) => {
    return [
...
const buildTotalInfoLog = (coverage, threshold) => {
    return [
        `Total: ${coverage}%`,
        `Threshold: ${threshold}%`
    ];
